...
2. DISCLOSE the withheld detail only when the specialist follows up on that specific aside — when their question names or clearly refers to the thing YOU mentioned (per "When you disclose it" above). Then answer plainly and cooperatively, in your own words, over one or two turns.
